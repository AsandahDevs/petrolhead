...
class manufacturer(models.Model):
    brand = models.CharField(primary_key=True)
    ...
    def __str__(self) -> str:
        return f'{self.brand} {self.founder} {self.year_founded} {self.headquarters} {self.model_name}'
...
class car_model(models.Model):
    ...
    def __str__(self) -> str:
        return f'{self.model_name} {self.model_year} {self.price} {self.transmission_type} {self.engine_position} {self.engine_litre} {self.fuel_consumption} {self.fuel_type} {self.cylinder_layout} {self.horsepower} {self.torque} {self.top_speed} {self.image_url} {self.segment}'
