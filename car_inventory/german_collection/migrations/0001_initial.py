    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='car_model', to='german_collection.manufacturer')),
            ],
        ),
        migrations.CreateModel(
            name='Segment',
            fields=[
                ...
                ('car_model_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='segment', to='german_collection.carmodel')),
            ],
        ),
    ]
